...
//El estimado del tiempo del reCAPTCHA es de unos dos minutos.
    ...
    fetch(API_CLIENTE + 'register', {
        ...
        if (request.ok) {
            request.json().then(function (response) {
                ...
                if (response.status) {
                    sweetAlert(1, response.message, 'iniciosesion.php');
                } else {
...
const API_REGISTRARSE = '../../app/api/public/crearcuenta.php?action=';
