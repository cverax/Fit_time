                    ...
                    response.dataset.map(function (row) {
                        ...
                        content += `
                            <tr>
                                ...
                                <td>
                                    <a href="#" onclick="openUpdateDialog(${row.Id_detalle_pedido}, ${row.cantidad})" class="btn waves-effect blue tooltipped" data-tooltip="Cambiar"><i class="material-icons">exposure</i></a>
